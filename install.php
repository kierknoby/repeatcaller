...
exten => s,1,NoOp(Repeat Caller alert playback)
 ...
 same => n,AGI(__REPEATCALLER_AGI_SCRIPT__,${REPEATCALLER_ALERT_HISTORY_ID},${REPEATCALLER_INCIDENT_ID},interactive,${REPEATCALLER_ALERT_RECIPIENT},${REPEATCALLER_PLAYBACK_TARGET},${REPEATCALLER_SUMMARY_MODE},${REPEATCALLER_SUMMARY_CALL_COUNT},${REPEATCALLER_SUMMARY_THRESHOLD},${REPEATCALLER_SUMMARY_WINDOW_MINUTES},${REPEATCALLER_SUMMARY_CALLER_KIND},${REPEATCALLER_SUMMARY_CALLER_VALUE},${REPEATCALLER_SUMMARY_DID_VALUE})
 same => n,Hangup()
