...
assert($('#rc-did-include-col').els[0].hidden === false && $('#rc-did-exclude-col').els[0].hidden === false, 'both DID route lists should remain visible in Selected DIDs mode');
...
hooks.updateDidScopeEditorState();
assert($('#rc-did-include-col').els[0].hidden === false && $('#rc-did-exclude-col').els[0].hidden === false, 'both DID route lists should remain visible in All DIDs mode');
$('#rc-route-pick').val('first|');
hooks.updateDidRouteActionButtonState();
assert($('#rc-add-did-include').prop('disabled') === true, 'the existing included route should disable only Include Route');
