				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-condensed" id="rc-alert-call-language-table">
							<thead><tr><th><?php echo _('Language'); ?></th><th><?php echo _('Installed'); ?></th><th><?php echo _('Alert Call Language'); ?></th><th><?php echo _('Status'); ?></th><th><?php echo _('Sample'); ?></th></tr></thead>
								<tbody>
