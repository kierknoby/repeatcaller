				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-condensed" id="rc-alert-call-language-table">
							<thead><tr><th><?php echo _('Language'); ?></th><th><?php echo _('Locale'); ?></th><th><?php echo _('Installed Codecs'); ?></th><th><?php echo _('Alert Call Language'); ?></th><th><?php echo _('Status'); ?></th><th><?php echo _('Sample'); ?></th></tr></thead>
								<tbody>
									<?php foreach ((array)($alertCallLanguageSupport['rows'] ?? []) as $languageStatus): ?>
										<tr<?php echo !empty($languageStatus['active']) ? ' class="info"' : ''; ?>>
											...
											<td><?php $installedCodecs = array_values((array)($languageStatus['installed_codecs'] ?? [])); echo htmlspecialchars($installedCodecs === [] ? '-' : implode(', ', $installedCodecs), ENT_QUOTES, 'UTF-8'); ?></td>
