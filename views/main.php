				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-condensed" id="rc-alert-call-language-table">
							<thead><tr><th><?php echo _('Language'); ?></th><th><?php echo _('Locale'); ?></th><th title="<?php echo htmlspecialchars(_('Shows the audio codecs available for the required Alert Call prompt set for this language/locale.'), ENT_QUOTES, 'UTF-8'); ?>"><?php echo _('Available Codecs'); ?></th><th><?php echo _('Status'); ?></th><th><?php echo _('Alert Call Language'); ?></th><th><?php echo _('Sample'); ?></th></tr></thead>
								<tbody>
