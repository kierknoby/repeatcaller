		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<p class="help-block"><?php echo _('Alert Call languages are based on installed audio files that can provide the required prompts, currently found under <code>/var/lib/asterisk/sounds</code>. The status shows whether native audio is available or whether fallback language will be used.'); ?></p>
				...
				<div class="panel-body">
					...
					<div class="panel panel-default rc-editor-panel">
						...
						<div class="panel-body">
							...
							<div class="row rc-row-gap"><div class="col-sm-3"><label><?php echo _('DID Scope'); ?></label><select id="rc-rule-did-mode" class="form-control"><option value="all"><?php echo _('Include All DIDs'); ?></option><option value="selected"><?php echo _('Select DIDs'); ?></option></select></div><div class="col-sm-6"><label><?php echo _('Inbound Routes'); ?></label><select id="rc-route-pick" class="form-control"></select></div><div class="col-sm-3" id="rc-did-route-actions-col"><label><?php echo _('Route Actions'); ?></label><div class="rc-route-actions"><button type="button" class="btn btn-xs btn-default" id="rc-add-did-include" disabled><?php echo _('Include Route'); ?></button> <button type="button" class="btn btn-xs btn-default" id="rc-add-did-exclude" disabled><?php echo _('Exclude Route'); ?></button></div></div></div>
