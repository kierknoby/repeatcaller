...
assert_true(strpos($readmeSource, 'resolved playback languages, and concise `Native`, `Fallback`, or `Unavailable`') !== false, 'README release history should document the simplified Alert Call language statuses');
