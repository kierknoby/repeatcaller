		...
		<div class="col-sm-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<p class="help-block"><?php echo _('Alert Call languages are based on installed audio files that can provide the required prompts, currently found under `/var/lib/asterisk/sounds`. The status shows whether native audio is available or whether fallback language will be used.'); ?></p>
